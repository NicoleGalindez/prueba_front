...
const Admin = () => {
    ...
    const loadData = async ()=>{
        try {
            ...
            const responseNoticias = await axios.get("https://nuevomern-7y1b.onrender.com/api/noticias");
    ...
    const deletePublication = async (data)=>{
        try {
            await axios.delete(`https://nuevomern-7y1b.onrender.com/api/noticias/${data._id}`);
                        ...
                        <div className="mt-8 overflow-y-auto">
                            ...
                            <div className="accepted-posts-container">
                                <div className="accepted-post">
                                    <img src="/placeholder-image.jpg" alt="Publicacion"
                                         className="accepted-post-image"/>
                                ...
                                <div className="p-4 w-2/3">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div>
                                            ...
                                            <button
                                                className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md" onClick={()=> deletePublication(data)}>
                                                Rechazar
                                            </button>
                                        </div>
                                    </div>
