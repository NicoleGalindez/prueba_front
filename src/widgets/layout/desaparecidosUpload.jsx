...
import {
  ...
  Input,
  Textarea,
  Checkbox // Importamos el componente Checkbox
...
export function DesaparecidosUpload() {
  ...
  return (
    <div className="p-10">
      ...
      <form onSubmit={handleSubmit} className="mx-auto w-full mt-4 lg:w-5/12">
        ...
        <Button type="submit" variant="gradient" size="lg" className="mt-1" fullWidth>
          Enviar reporte
        </Button>
      </form>
    </div>
